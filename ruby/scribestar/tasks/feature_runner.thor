...
class FeatureRunner < Thor
  ...
  feature_runner_options.call   #Set up common feature runner options as defined above
  def all_drivers_runner
    if options[:threaded]
      feature_run = lambda {
        thread_pool = []

        t = Thread.new do |driver|
...
=end
      ...
      feature_run = lambda {
        ...
        #invoke "feature_runner:set_driver_to_opera", options
      }
    end
    ...
    if options[:benchmark]
      ...
      puts "Elapsed Real Time: #{measure.real}"
    else
      feature_run.call
    end
  end
  ...
  desc "set_driver_to_firefox", "Run features in firefox"
  ...
  desc "set_driver_to_chrome", "Run features in chrome"
  feature_runner_options.call
  ...
  desc "set_driver_to_ie", "Run features in internet explorer"
  feature_runner_options.call
  ...
  desc "set_driver_to_opera", "Run features in opera"
  feature_runner_options.call
